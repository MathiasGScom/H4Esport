...
namespace eSportPortalAPI.Controllers
{
    ...
    {
        private readonly eSportPortalDbContext _context;

        public UsersController(eSportPortalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          if (_context.Users == null)
          {
              return Problem("Entity set 'eSportPortalDbContext.Users'  is null.");
          }
